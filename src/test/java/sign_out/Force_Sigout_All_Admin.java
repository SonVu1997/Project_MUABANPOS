...
public class Force_Sigout_All_Admin {
	WebDriver driver;
...
//		  click button "Login"
	...
	@Test(description = "Action button force sigout", priority = 2)
	public void Action_Button_Force_Singout() {
		...
		wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[3]/div[1]/nav/ul/li[3]/ul/li[3]/a")));
		driver.findElement(By.xpath("/html/body/div[3]/div[1]/nav/ul/li[3]/ul/li[3]/a")).click();
	}

	@Test(description = "Force admin successfully", priority = 3)
	public void Force_Sigout() {
