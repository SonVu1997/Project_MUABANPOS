...
public class Change_Pass_Failed_5 {
	WebDriver driver;
...
//	  Login successfully
  ...
  @Test(description = "Change password failed with new password space character", priority =3)
...
//	  input password first
	  ...
	  driver.findElement(By.id("dashpassword_change")).sendKeys("123 456");
//	  input new password
	  driver.findElement(By.id("dashpassword_change2")).click();
	  driver.findElement(By.id("dashpassword_change2")).sendKeys("123 456");
...
//	  click button "cap nhat"
	  ...
	  Assert.assertEquals( actualResult,"Mật khẩu không được có ký tự dấu cách");
