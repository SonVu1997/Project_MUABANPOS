...
public class Change_Pass_Failed_6 {
	WebDriver driver;
...
//	  Login successfully
  ...
  @Test(description = "Change password with password nho hon 6 ki tu ", priority = 3)
...
//	  input password first
	  ...
	  driver.findElement(By.id("dashpassword_change")).sendKeys("12345");
//	  input new password
	  driver.findElement(By.id("dashpassword_change2")).click();
	  driver.findElement(By.id("dashpassword_change2")).sendKeys("12345");
...
//	  click button "cap nhat"
	  ...
	  Assert.assertEquals(actualResult, "Mật khẩu phải ít nhất 6 ký tự");
